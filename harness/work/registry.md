...
| `mvp-backend-persistence-slice` | active | commit-manager | commit scoped backend persistence slice | none | `harness/work/mvp-backend-persistence-slice/` | none | `harness/owner/decisions/2026-06-12-ai-owned-report-first-workflow.md` | `harness/owner/reports/2026-06-12-mvp-backend-persistence-slice.md` |
