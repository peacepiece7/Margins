...
| `mvp-infra-mysql-runtime` | active | infra-engineer | run MySQL compose script and verify schema/seed | none | `harness/work/mvp-infra-mysql-runtime/` | none | `harness/owner/decisions/2026-06-12-ai-owned-report-first-workflow.md` | `harness/owner/reports/2026-06-12-mvp-infra-mysql-runtime.md` |
