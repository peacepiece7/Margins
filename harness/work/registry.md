...
| `mvp-backend-persistence-slice` | ready | backend-engineer | implement mapper-backed insert paths | none | `harness/work/mvp-backend-persistence-slice/` | none | `harness/owner/decisions/2026-06-12-ai-owned-report-first-workflow.md` | `harness/owner/reports/2026-06-12-mvp-backend-persistence-slice.md` |
| `harness-autonomy-upgrade` | active | qa-engineer | verify harness autonomy upgrade | none | `harness/work/harness-autonomy-upgrade/` | none | `harness/owner/decisions/2026-06-12-ai-owned-report-first-workflow.md` | `harness/owner/reports/2026-06-12-harness-autonomy-upgrade.md` |
