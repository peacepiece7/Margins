...
| `mvp-build-tooling` | active | qa-engineer | run backend test script and revise if needed | none | `harness/work/mvp-build-tooling/` | none | `harness/owner/decisions/2026-06-12-ai-owned-report-first-workflow.md` | `harness/owner/reports/2026-06-12-mvp-build-tooling.md` |
