...
| `harness/owner/reports/2026-06-12-mvp-backend-skeleton.md` | reported | Backend skeleton is ready for commit; test execution is deferred until Gradle or wrapper is available. |
